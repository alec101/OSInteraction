...
void _Kv::populate() {
  ...
  insert= XKeysymToKeycode(osi.primWin->dis, XK_Insert);
  del= XKeysymToKeycode(osi.primWin->dis, XK_Delete);
  home= XKeysymToKeycode(osi.primWin->dis, XK_Home);
  ...
  lctrl= XKeysymToKeycode(osi.primWin->dis, XK_Control_L);
  ralt= XKeysymToKeycode(osi.primWin->dis, XK_Alt_R);
  lalt= XKeysymToKeycode(osi.primWin->dis, XK_Alt_L);
  f1= XKeysymToKeycode(osi.primWin->dis, XK_F1);
  f2= XKeysymToKeycode(osi.primWin->dis, XK_F2);
  f3= XKeysymToKeycode(osi.primWin->dis, XK_F3);
  f4= XKeysymToKeycode(osi.primWin->dis, XK_F4);
  f5= XKeysymToKeycode(osi.primWin->dis, XK_F5);
  f6= XKeysymToKeycode(osi.primWin->dis, XK_F6);
  f7= XKeysymToKeycode(osi.primWin->dis, XK_F7);
  f8= XKeysymToKeycode(osi.primWin->dis, XK_F8);
  f9= XKeysymToKeycode(osi.primWin->dis, XK_F9);
  f10= XKeysymToKeycode(osi.primWin->dis, XK_F10);
  f11= XKeysymToKeycode(osi.primWin->dis, XK_F11);
  f12= XKeysymToKeycode(osi.primWin->dis, XK_F12);
  left= XKeysymToKeycode(osi.primWin->dis, XK_Left);
  ...
  scrolllock= XKeysymToKeycode(osi.primWin->dis, XK_Scroll_Lock);
  numlock= XKeysymToKeycode(osi.primWin->dis, XK_Num_Lock);
  q= XKeysymToKeycode(osi.primWin->dis, XK_q);
  w= XKeysymToKeycode(osi.primWin->dis, XK_w);
  e= XKeysymToKeycode(osi.primWin->dis, XK_e);
  r= XKeysymToKeycode(osi.primWin->dis, XK_r);
  t= XKeysymToKeycode(osi.primWin->dis, XK_t);
  y= XKeysymToKeycode(osi.primWin->dis, XK_y);
  u= XKeysymToKeycode(osi.primWin->dis, XK_u);
  i= XKeysymToKeycode(osi.primWin->dis, XK_i);
  o= XKeysymToKeycode(osi.primWin->dis, XK_o);
  p= XKeysymToKeycode(osi.primWin->dis, XK_p);
  a= XKeysymToKeycode(osi.primWin->dis, XK_a);
  s= XKeysymToKeycode(osi.primWin->dis, XK_s);
  d= XKeysymToKeycode(osi.primWin->dis, XK_d);
  f= XKeysymToKeycode(osi.primWin->dis, XK_f);
  g= XKeysymToKeycode(osi.primWin->dis, XK_g);
  h= XKeysymToKeycode(osi.primWin->dis, XK_h);
  j= XKeysymToKeycode(osi.primWin->dis, XK_j);
  k= XKeysymToKeycode(osi.primWin->dis, XK_k);
  l= XKeysymToKeycode(osi.primWin->dis, XK_l);
  z= XKeysymToKeycode(osi.primWin->dis, XK_z);
  x= XKeysymToKeycode(osi.primWin->dis, XK_x);
  c= XKeysymToKeycode(osi.primWin->dis, XK_c);
  v= XKeysymToKeycode(osi.primWin->dis, XK_v);
  b= XKeysymToKeycode(osi.primWin->dis, XK_b);
  n= XKeysymToKeycode(osi.primWin->dis, XK_n);
  m= XKeysymToKeycode(osi.primWin->dis, XK_m);
  n1= XKeysymToKeycode(osi.primWin->dis, XK_1);
  n2= XKeysymToKeycode(osi.primWin->dis, XK_2);
  n3= XKeysymToKeycode(osi.primWin->dis, XK_3);
  n4= XKeysymToKeycode(osi.primWin->dis, XK_4);
  n5= XKeysymToKeycode(osi.primWin->dis, XK_5);
  n6= XKeysymToKeycode(osi.primWin->dis, XK_6);
  n7= XKeysymToKeycode(osi.primWin->dis, XK_7);
  n8= XKeysymToKeycode(osi.primWin->dis, XK_8);
  ...
  semicolon= XKeysymToKeycode(osi.primWin->dis, XK_semicolon);
  apostrophe= XKeysymToKeycode(osi.primWin->dis, XK_apostrophe);
  comma= XKeysymToKeycode(osi.primWin->dis, XK_comma);
