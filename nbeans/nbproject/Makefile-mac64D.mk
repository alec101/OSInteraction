...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../output/OSInteraction_dbg.mac

../output/OSInteraction_dbg.mac: ${OBJECTFILES}
	${MKDIR} -p ../output
	${LINK.cc} -o ../output/OSInteraction_dbg.mac ${OBJECTFILES} ${LDLIBSOPTIONS} -framework OpenGL -framework cocoa -framework IOKit
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../output/OSInteraction_dbg.mac
