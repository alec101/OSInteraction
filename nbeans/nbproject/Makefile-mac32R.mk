...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../output/OSInteraction32.mac

../output/OSInteraction32.mac: ${OBJECTFILES}
	${MKDIR} -p ../output
	${LINK.cc} -o ../output/OSInteraction32.mac ${OBJECTFILES} ${LDLIBSOPTIONS} -framework OpenGL -framework cocoa
