...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../output/osi64linux.lib

../output/osi64linux.lib: ${OBJECTFILES}
	${MKDIR} -p ../output
	${RM} ../output/osi64linux.lib
	${AR} -rv ../output/osi64linux.lib ${OBJECTFILES} 
	$(RANLIB) ../output/osi64linux.lib
