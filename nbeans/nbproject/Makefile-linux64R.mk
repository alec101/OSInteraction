...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../lib/osi64linux.so

../lib/osi64linux.so: ${OBJECTFILES}
	${MKDIR} -p ../lib
	${RM} ../lib/osi64linux.so
	${AR} -rv ../lib/osi64linux.so ${OBJECTFILES} 
	$(RANLIB) ../lib/osi64linux.so
