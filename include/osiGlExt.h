...
//   under the hood they point to the currently active renderer's extension functions
...
/* important:
GL_NV_path_rendering is both in glcorearb.h and glext.h, in the newest files from khronos (5/dec/2018) i had to disable this extension cuz this is absurd
*/
...
struct osiGlExt {
  ...
  osiGlExt() { desc= NULL; avaible= false; }
  osiGlExt(const char *s, bool b): desc(s), avaible(b) {}
};

extern osiGlExt _glARBlistEmpty[];   /// [internal] each renderer will create it's starting glARBlist from this
extern osiGlExt _glEXTlistEmpty[];   /// [internal] each renderer will create it's starting glEXTlist from this
extern osiGlExt _glOTHERlistEmpty[]; /// [internal] each renderer will create it's starting glOTHERlist from this
...
struct osiGlExtFuncs {
  ...
  osiGlExtFuncs() { initialized= false; }
  ...
  */
  ...
  PFNVOIDFUNCPROC glMatrixLoad3x2fNV;
  PFNVOIDFUNCPROC glMatrixLoad3x3fNV;
  PFNVOIDFUNCPROC glMatrixLoadTranspose3x3fNV;
  PFNVOIDFUNCPROC glMatrixMult3x2fNV;
  PFNVOIDFUNCPROC glMatrixMult3x3fNV;
  PFNVOIDFUNCPROC glMatrixMultTranspose3x3fNV;
  PFNVOIDFUNCPROC glStencilThenCoverFillPathNV;
  PFNVOIDFUNCPROC glStencilThenCoverStrokePathNV;
  PFNVOIDFUNCPROC glStencilThenCoverFillPathInstancedNV;
  PFNVOIDFUNCPROC glStencilThenCoverStrokePathInstancedNV;
  PFNVOIDFUNCPROC glPathGlyphIndexRangeNV;
  PFNVOIDFUNCPROC glPathGlyphIndexArrayNV;
  PFNVOIDFUNCPROC glPathMemoryGlyphIndexArrayNV;
  PFNVOIDFUNCPROC glProgramPathFragmentInputGenNV;
  PFNVOIDFUNCPROC glGetProgramResourcefvNV;
...
//typedef osiGlExtFuncs glExtFuncs;

#ifndef OS_WIN
extern osiGlExtFuncs glExt;        /// one set of function pointers for MAC and LINUX; windows have functions for each renderer
...
inline GLAPI void APIENTRY glClearNamedFramebufferfi (GLuint framebuffer, GLenum buffer, GLint drawbuffer, GLfloat depth, GLint stencil) {
  ((PFNGLCLEARNAMEDFRAMEBUFFERFIPROC)_glr->glExt.glClearNamedFramebufferfi) (framebuffer, buffer, drawbuffer, depth, stencil);}
...
inline GLAPI void APIENTRY glMultiDrawArraysIndirectCountARB (GLenum mode, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride) {
...
inline GLAPI void APIENTRY glMultiDrawElementsIndirectCountARB (GLenum mode, GLenum type, const void *indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride) {
...
#if(GL_NV_path_rendering== 123) // #410       DISABLED
...
inline GLAPI void APIENTRY glMatrixLoad3x2fNV (GLenum matrixMode, const GLfloat *m) {
  ((PFNGLMATRIXLOAD3X2FNVPROC)_glr->glExt.glMatrixLoad3x2fNV) (matrixMode, m); }
inline GLAPI void APIENTRY glMatrixLoad3x3fNV (GLenum matrixMode, const GLfloat *m) {
  ((PFNGLMATRIXLOAD3X3FNVPROC)_glr->glExt.glMatrixLoad3x3fNV) (matrixMode, m); }
inline GLAPI void APIENTRY glMatrixLoadTranspose3x3fNV (GLenum matrixMode, const GLfloat *m) {
  ((PFNGLMATRIXLOADTRANSPOSE3X3FNVPROC)_glr->glExt.glMatrixLoadTranspose3x3fNV) (matrixMode, m); }
inline GLAPI void APIENTRY glMatrixMult3x2fNV (GLenum matrixMode, const GLfloat *m) {
  ((PFNGLMATRIXMULT3X2FNVPROC)_glr->glExt.glMatrixMult3x2fNV) (matrixMode, m); }
inline GLAPI void APIENTRY glMatrixMult3x3fNV (GLenum matrixMode, const GLfloat *m) {
  ((PFNGLMATRIXMULT3X3FNVPROC)_glr->glExt.glMatrixMult3x3fNV) (matrixMode, m); }
inline GLAPI void APIENTRY glMatrixMultTranspose3x3fNV (GLenum matrixMode, const GLfloat *m) {
  ((PFNGLMATRIXMULTTRANSPOSE3X3FNVPROC)_glr->glExt.glMatrixMultTranspose3x3fNV) (matrixMode, m); }
inline GLAPI void APIENTRY glStencilThenCoverFillPathNV (GLuint path, GLenum fillMode, GLuint mask, GLenum coverMode) {
  ((PFNGLSTENCILTHENCOVERFILLPATHNVPROC)_glr->glExt.glStencilThenCoverFillPathNV) (path, fillMode, mask, coverMode); }
inline GLAPI void APIENTRY glStencilThenCoverStrokePathNV (GLuint path, GLint reference, GLuint mask, GLenum coverMode) {
  ((PFNGLSTENCILTHENCOVERSTROKEPATHNVPROC)_glr->glExt.glStencilThenCoverStrokePathNV) (path, reference, mask, coverMode); }
inline GLAPI void APIENTRY glStencilThenCoverFillPathInstancedNV (GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLenum fillMode, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat *transformValues) {
  ((PFNGLSTENCILTHENCOVERFILLPATHINSTANCEDNVPROC)_glr->glExt.glStencilThenCoverFillPathInstancedNV) (numPaths, pathNameType, paths, pathBase, fillMode, mask, coverMode, transformType, transformValues); }
inline GLAPI void APIENTRY glStencilThenCoverStrokePathInstancedNV (GLsizei numPaths, GLenum pathNameType, const void *paths, GLuint pathBase, GLint reference, GLuint mask, GLenum coverMode, GLenum transformType, const GLfloat *transformValues) {
  ((PFNGLSTENCILTHENCOVERSTROKEPATHINSTANCEDNVPROC)_glr->glExt.glStencilThenCoverStrokePathInstancedNV) (numPaths, pathNameType, paths, pathBase, reference, mask, coverMode, transformType, transformValues); }
inline GLAPI GLenum APIENTRY glPathGlyphIndexRangeNV (GLenum fontTarget, const void *fontName, GLbitfield fontStyle, GLuint pathParameterTemplate, GLfloat emScale, GLuint baseAndCount[2]) {
  return ((PFNGLPATHGLYPHINDEXRANGENVPROC)_glr->glExt.glPathGlyphIndexRangeNV) (fontTarget, fontName, fontStyle, pathParameterTemplate, emScale, baseAndCount); }
inline GLAPI GLenum APIENTRY glPathGlyphIndexArrayNV (GLuint firstPathName, GLenum fontTarget, const void *fontName, GLbitfield fontStyle, GLuint firstGlyphIndex, GLsizei numGlyphs, GLuint pathParameterTemplate, GLfloat emScale) {
  return ((PFNGLPATHGLYPHINDEXARRAYNVPROC)_glr->glExt.glPathGlyphIndexArrayNV) (firstPathName, fontTarget, fontName, fontStyle, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale); }
inline GLAPI GLenum APIENTRY glPathMemoryGlyphIndexArrayNV (GLuint firstPathName, GLenum fontTarget, GLsizeiptr fontSize, const void *fontData, GLsizei faceIndex, GLuint firstGlyphIndex, GLsizei numGlyphs, GLuint pathParameterTemplate, GLfloat emScale) {
  return ((PFNGLPATHMEMORYGLYPHINDEXARRAYNVPROC)_glr->glExt.glPathMemoryGlyphIndexArrayNV) (firstPathName, fontTarget, fontSize, fontData, faceIndex, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale); }
inline GLAPI void APIENTRY glProgramPathFragmentInputGenNV (GLuint program, GLint location, GLenum genMode, GLint components, const GLfloat *coeffs) {
  ((PFNGLPROGRAMPATHFRAGMENTINPUTGENNVPROC)_glr->glExt.glProgramPathFragmentInputGenNV) (program, location, genMode, components, coeffs); }
inline GLAPI void APIENTRY glGetProgramResourcefvNV (GLuint program, GLenum programInterface, GLuint index, GLsizei propCount, const GLenum *props, GLsizei bufSize, GLsizei *length, GLfloat *params) {
  ((PFNGLGETPROGRAMRESOURCEFVNVPROC)_glr->glExt.glGetProgramResourcefvNV) (program, programInterface, index, propCount, props, bufSize, length, params); }
